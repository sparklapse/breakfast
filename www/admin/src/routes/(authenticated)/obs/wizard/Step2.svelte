<script lang="ts">
  ...
  import websocketMenu from "./websocket-settings.png";
...
>
  <div class="flex flex-col items-center gap-2 max-w-lg">
    <div class="h-72 overflow-hidden">
      <img src={websocketMenu} alt="" />
    </div>
    <p class="text-xl">Check "Enable WebSocket server" and make sure "Enable authentication" is also checked</p>
